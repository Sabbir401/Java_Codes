...
public class TcpFlowControl {
    ...
    public static int generateAck(int noOfSent) {
        ...
        //number of ack−ed frames is mod within the total number of frames to−besent

        //since number of ack−ed frames can never be more than total number offrames to−be sent
        return noOfAckFrame;
    }
